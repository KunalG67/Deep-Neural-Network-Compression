...
def prune_model(model, threshold=0.95):
    """
    Iterates all modified layers and applies weight pruning.
    Weights with absolute value < threshold are zeroed out.
    """
...
def count_sparsity(model):
    """
    Prints and returns the sparsity of the model.
    Sparsity = fraction of zero weights across all modified layers.
    """
    total = 0
    zeros = 0
